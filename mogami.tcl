...
#
# mogami.tcl: Tcl script for re-creating project 'Mogami'
#
# Generated by Vivado on Fri Dec 21 10:20:43 -0800 2018
...
#
# 1. This project restoration tcl script (mogami.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "E:/Mogamigawa/design/memory/common.v"
#    "E:/Mogamigawa/design/memory/cache_il1_control.v"
#    "E:/Mogamigawa/design/arithmetic/integer/comparator.v"
#    "E:/Mogamigawa/design/memory/RegFile.v"
#    "E:/Mogamigawa/reservation_station.v"
#    "E:/Mogamigawa/rob.v"
#    "E:/Mogamigawa/issue_buffer.v"
#    "E:/Mogamigawa/Mogami/Mogami.srcs/sim_1/imports/verification/cache_il1_control.sv"
#
...
set orig_proj_dir "[file normalize "$origin_dir/Mogami"]"

# Create project
create_project ${project_name} ./${project_name} -part xc7a100tfgg484-2
...
set files [list \
 "[file normalize "$origin_dir/design/memory/common.v"]"\
 "[file normalize "$origin_dir/design/memory/cache_il1_control.v"]"\
 "[file normalize "$origin_dir/design/arithmetic/integer/comparator.v"]"\
 "[file normalize "$origin_dir/design/memory/RegFile.v"]"\
 "[file normalize "$origin_dir/design/control/reservation_station.v"]"\
 "[file normalize "$origin_dir/design/control/rob.v"]"\
 "[file normalize "$origin_dir/design/control/issue_buffer.v"]"\
]
...
set file "memory/cache_il1_control.v"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
...
set file "control/reservation_station.v"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
...
set file "control/issue_buffer.v"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
...
set_property -name "top" -value "controller_il1" -objects $obj
...
# Import local files from the original project
set files [list \
 "[file normalize "$origin_dir/verification/cache_il1_control.sv"]"\
]
...
set file "verification/cache_il1_control.sv"
...
set_property -name "top" -value "cache_il1_valid_table_test" -objects $obj
...
# Proc to create BD cache_il1
proc cr_bd_cache_il1 { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name cache_il1
  ...
  set ram_d0 [ create_bd_port -dir O -from 179 -to 0 -type data ram_d0 ]
  set ram_d1 [ create_bd_port -dir O -from 179 -to 0 -type data ram_d1 ]
  set ram_d2 [ create_bd_port -dir O -from 179 -to 0 -type data ram_d2 ]
  set ram_d3 [ create_bd_port -dir O -from 179 -to 0 -type data ram_d3 ]
  set ram_en [ create_bd_port -dir I -from 3 -to 0 ram_en ]
  set ram_wd [ create_bd_port -dir I -from 179 -to 0 -type data ram_wd ]
  set read_addr [ create_bd_port -dir I -from 7 -to 0 read_addr ]
  set wrtie_addr [ create_bd_port -dir I -from 7 -to 0 wrtie_addr ]

  # Create instance: cache_ram0, and set properties
  set cache_ram0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen:8.4 cache_ram0 ]
  set_property -dict [ list \
   CONFIG.Byte_Size {9} \
   ...
   CONFIG.Read_Width_A {180} \
   CONFIG.Read_Width_B {180} \
   CONFIG.Register_PortA_Output_of_Memory_Primitives {false} \
   CONFIG.Register_PortB_Output_of_Memory_Primitives {true} \
   CONFIG.Use_Byte_Write_Enable {false} \
   CONFIG.Use_RSTA_Pin {false} \
   CONFIG.Write_Depth_A {256} \
   CONFIG.Write_Width_A {180} \
   CONFIG.Write_Width_B {180} \
   CONFIG.use_bram_block {Stand_Alone} \
 ] $cache_ram0

  # Create instance: cache_ram1, and set properties
  set cache_ram1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen:8.4 cache_ram1 ]
  set_property -dict [ list \
   CONFIG.Byte_Size {9} \
   CONFIG.EN_SAFETY_CKT {false} \
   CONFIG.Enable_32bit_Address {false} \
  ...
  # Create instance: cache_ram2, and set properties
  set cache_ram2 [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen:8.4 cache_ram2 ]
  set_property -dict [ list \
   CONFIG.Byte_Size {9} \
   CONFIG.EN_SAFETY_CKT {false} \
   CONFIG.Enable_32bit_Address {false} \
  ...
  # Create instance: cache_ram3, and set properties
  set cache_ram3 [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen:8.4 cache_ram3 ]
  set_property -dict [ list \
   CONFIG.Byte_Size {9} \
   CONFIG.EN_SAFETY_CKT {false} \
   CONFIG.Enable_32bit_Address {false} \
  ...
  connect_bd_net -net cache_ram0_doutb [get_bd_ports ram_d0] [get_bd_pins cache_ram0/doutb]
  connect_bd_net -net cache_ram1_doutb [get_bd_ports ram_d1] [get_bd_pins cache_ram1/doutb]
  connect_bd_net -net cache_ram2_doutb [get_bd_ports ram_d2] [get_bd_pins cache_ram2/doutb]
  connect_bd_net -net cache_ram3_doutb [get_bd_ports ram_d3] [get_bd_pins cache_ram3/doutb]
  connect_bd_net -net clk_1 [get_bd_ports clk] [get_bd_pins cache_ram0/clka] [get_bd_pins cache_ram0/clkb] [get_bd_pins cache_ram1/clka] [get_bd_pins cache_ram1/clkb] [get_bd_pins cache_ram2/clka] [get_bd_pins cache_ram2/clkb] [get_bd_pins cache_ram3/clka] [get_bd_pins cache_ram3/clkb]
  connect_bd_net -net ram_en_1 [get_bd_ports ram_en] [get_bd_pins xlslice_0/Din] [get_bd_pins xlslice_1/Din] [get_bd_pins xlslice_2/Din] [get_bd_pins xlslice_3/Din]
  connect_bd_net -net ram_wd_1 [get_bd_ports ram_wd] [get_bd_pins cache_ram0/dina] [get_bd_pins cache_ram1/dina] [get_bd_pins cache_ram2/dina] [get_bd_pins cache_ram3/dina]
  connect_bd_net -net read_addr_1 [get_bd_ports read_addr] [get_bd_pins cache_ram0/addrb] [get_bd_pins cache_ram1/addrb] [get_bd_pins cache_ram2/addrb] [get_bd_pins cache_ram3/addrb]
  connect_bd_net -net wrtie_addr_1 [get_bd_ports wrtie_addr] [get_bd_pins cache_ram0/addra] [get_bd_pins cache_ram1/addra] [get_bd_pins cache_ram2/addra] [get_bd_pins cache_ram3/addra]
  connect_bd_net -net xlslice_0_Dout [get_bd_pins cache_ram0/wea] [get_bd_pins xlslice_0/Dout]
  connect_bd_net -net xlslice_1_Dout [get_bd_pins cache_ram1/wea] [get_bd_pins xlslice_1/Dout]
  connect_bd_net -net xlslice_2_Dout [get_bd_pins cache_ram2/wea] [get_bd_pins xlslice_2/Dout]
  connect_bd_net -net xlslice_3_Dout [get_bd_pins cache_ram3/wea] [get_bd_pins xlslice_3/Dout]
...
# End of cr_bd_cache_il1()
cr_bd_cache_il1 ""
set_property EXCLUDE_DEBUG_LOGIC "0" [get_files cache_il1.bd ]
set_property GENERATE_SYNTH_CHECKPOINT "1" [get_files cache_il1.bd ]
set_property IS_ENABLED "1" [get_files cache_il1.bd ]
set_property IS_GLOBAL_INCLUDE "0" [get_files cache_il1.bd ]
set_property IS_LOCKED "0" [get_files cache_il1.bd ]
set_property LIBRARY "xil_defaultlib" [get_files cache_il1.bd ]
set_property PATH_MODE "RelativeFirst" [get_files cache_il1.bd ]
set_property PFM_NAME "" [get_files cache_il1.bd ]
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files cache_il1.bd ]
set_property USED_IN "synthesis implementation simulation" [get_files cache_il1.bd ]
set_property USED_IN_IMPLEMENTATION "1" [get_files cache_il1.bd ]
set_property USED_IN_SIMULATION "1" [get_files cache_il1.bd ]
set_property USED_IN_SYNTHESIS "1" [get_files cache_il1.bd ]



# Proc to create BD cache_dl1
proc cr_bd_cache_dl1 { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name cache_dl1
  ...
  # Create instance: cache_ram, and set properties
  set cache_ram [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen:8.4 cache_ram ]
  set_property -dict [ list \
   CONFIG.Byte_Size {9} \
   CONFIG.EN_SAFETY_CKT {false} \
   CONFIG.Enable_32bit_Address {false} \
   ...
   CONFIG.Read_Width_A {558} \
   CONFIG.Read_Width_B {558} \
   CONFIG.Register_PortA_Output_of_Memory_Primitives {true} \
   CONFIG.Register_PortB_Output_of_Memory_Primitives {true} \
   CONFIG.Use_Byte_Write_Enable {false} \
   CONFIG.Use_RSTA_Pin {false} \
   CONFIG.Write_Depth_A {256} \
   CONFIG.Write_Width_A {558} \
   CONFIG.Write_Width_B {558} \
   CONFIG.use_bram_block {Stand_Alone} \
 ] $cache_ram
...
# End of cr_bd_cache_dl1()
cr_bd_cache_dl1 ""
set_property EXCLUDE_DEBUG_LOGIC "0" [get_files cache_dl1.bd ]
set_property GENERATE_SYNTH_CHECKPOINT "1" [get_files cache_dl1.bd ]
set_property IS_ENABLED "1" [get_files cache_dl1.bd ]
set_property IS_GLOBAL_INCLUDE "0" [get_files cache_dl1.bd ]
set_property IS_LOCKED "0" [get_files cache_dl1.bd ]
set_property LIBRARY "xil_defaultlib" [get_files cache_dl1.bd ]
set_property PATH_MODE "RelativeFirst" [get_files cache_dl1.bd ]
set_property PFM_NAME "" [get_files cache_dl1.bd ]
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files cache_dl1.bd ]
set_property USED_IN "synthesis implementation simulation" [get_files cache_dl1.bd ]
set_property USED_IN_IMPLEMENTATION "1" [get_files cache_dl1.bd ]
set_property USED_IN_SIMULATION "1" [get_files cache_dl1.bd ]
set_property USED_IN_SYNTHESIS "1" [get_files cache_dl1.bd ]



# Proc to create BD cache_l2
proc cr_bd_cache_l2 { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name cache_l2
...
# End of cr_bd_cache_l2()
cr_bd_cache_l2 ""
set_property EXCLUDE_DEBUG_LOGIC "0" [get_files cache_l2.bd ]
set_property GENERATE_SYNTH_CHECKPOINT "1" [get_files cache_l2.bd ]
set_property IS_ENABLED "1" [get_files cache_l2.bd ]
set_property IS_GLOBAL_INCLUDE "0" [get_files cache_l2.bd ]
set_property IS_LOCKED "0" [get_files cache_l2.bd ]
set_property LIBRARY "xil_defaultlib" [get_files cache_l2.bd ]
set_property PATH_MODE "RelativeFirst" [get_files cache_l2.bd ]
set_property PFM_NAME "" [get_files cache_l2.bd ]
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files cache_l2.bd ]
set_property USED_IN "synthesis implementation simulation" [get_files cache_l2.bd ]
set_property USED_IN_IMPLEMENTATION "1" [get_files cache_l2.bd ]
set_property USED_IN_SIMULATION "1" [get_files cache_l2.bd ]
set_property USED_IN_SYNTHESIS "1" [get_files cache_l2.bd ]



# Proc to create BD regfile
proc cr_bd_regfile { parentCell } {
  ...
  # Create instance: regfile_ram0, and set properties
  set regfile_ram0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen:8.4 regfile_ram0 ]
  set_property -dict [ list \
   CONFIG.Byte_Size {9} \
   CONFIG.EN_SAFETY_CKT {false} \
   CONFIG.Enable_32bit_Address {false} \
  ...
  # Create instance: regfile_ram1, and set properties
  set regfile_ram1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen:8.4 regfile_ram1 ]
  set_property -dict [ list \
   CONFIG.Byte_Size {9} \
   CONFIG.EN_SAFETY_CKT {false} \
   CONFIG.Enable_32bit_Address {false} \
  ...
  # Create instance: regfile_ram2, and set properties
  set regfile_ram2 [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen:8.4 regfile_ram2 ]
  set_property -dict [ list \
   CONFIG.Byte_Size {9} \
   CONFIG.EN_SAFETY_CKT {false} \
   CONFIG.Enable_32bit_Address {false} \
  ...
  # Create instance: regfile_ram3, and set properties
  set regfile_ram3 [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen:8.4 regfile_ram3 ]
  set_property -dict [ list \
   CONFIG.Byte_Size {9} \
   CONFIG.EN_SAFETY_CKT {false} \
   CONFIG.Enable_32bit_Address {false} \
...
# End of cr_bd_regfile()
cr_bd_regfile ""
set_property EXCLUDE_DEBUG_LOGIC "0" [get_files regfile.bd ]
set_property GENERATE_SYNTH_CHECKPOINT "1" [get_files regfile.bd ]
set_property IS_ENABLED "1" [get_files regfile.bd ]
set_property IS_GLOBAL_INCLUDE "0" [get_files regfile.bd ]
set_property IS_LOCKED "0" [get_files regfile.bd ]
set_property LIBRARY "xil_defaultlib" [get_files regfile.bd ]
set_property PATH_MODE "RelativeFirst" [get_files regfile.bd ]
set_property PFM_NAME "" [get_files regfile.bd ]
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files regfile.bd ]
set_property USED_IN "synthesis implementation simulation" [get_files regfile.bd ]
set_property USED_IN_IMPLEMENTATION "1" [get_files regfile.bd ]
set_property USED_IN_SIMULATION "1" [get_files regfile.bd ]
set_property USED_IN_SYNTHESIS "1" [get_files regfile.bd ]
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xc7a100tfgg484-2 -flow {Vivado Implementation 2017} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
